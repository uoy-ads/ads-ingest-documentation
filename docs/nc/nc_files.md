...
Deposits can be made by simply dragging and dropping your files directly into the system.

**Step 1 - Upload Core Metadata Template**

Begin by downloading the ‘Core Metadata Template’ using the link provided. All of the metadata for the data in your collection can be compiled within this simple easy to use template. 

The template contains some example entries as well as additional information to help you complete the necessary fields. For more details about how to complete the Metadata template, please view the [Core Metadata template](/docs/cmt/index.md) help menu.
...
<figure markdown="span">
  ![Core Metadata Template Error](./assets/metadata_errors.png){ width="450" }
...
You must rectify your errors and reupload the Core Metadata template before you can continue.
...
<figure markdown="span">
  ![Uploaded Core Metadata Template table](./assets/upload_complete.png){ width="550" }
  <figcaption></figcaption>
</figure>
...
Press ‘Add Rows’ to select an additional core metadata template containing additional rows. Please note that if this file contains the same information as the first template uploaded, then the system will highlight these duplicates as errors.
...
To do this drag and drop a folder containing your files into the drop zone. Please note that the folder must not be compressed in any way (e.g. zipped) to upload it to the system.

<figure markdown="span">
  ![Uploaded Files](./assets/upload_files.png){ width="550" }
  <figcaption></figcaption>
</figure>

As you add the data, the system will process the files and automatically highlight any issues. These may be mismatches between the files you have deposited and the core metadata template. To navigate these issues you can click on the underlined errors and it will expand the list to show the files that are affected.

<figure markdown="span">
  ![File Upload Error](./assets/file_upload_error.png){ width="450" }
  <figcaption></figcaption>
</figure>
...
<figure markdown="span">
  ![Uploaded Files](./assets/upload_complete2.png){ width="550" }
  <figcaption></figcaption>
</figure>
