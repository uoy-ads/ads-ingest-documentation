...
The [Costing Calculator](https://ingest.archaeologydataservice.ac.uk/costing-calculator) is accessed via the top right hand corner of the Dashboard. This costing calculator can be used to generate a quotation for depositing a dataset via Ingest.
