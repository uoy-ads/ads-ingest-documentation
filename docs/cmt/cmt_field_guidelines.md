The following section provides detailed guidance for each field in the core metadata template including descriptions and examples. 

The fieldnames denoted with a * are required fields.
